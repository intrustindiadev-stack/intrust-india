...
INSERT INTO teams (id, name, region_level, state, city, area)
VALUES ('77777777-7777-7777-7777-777777777777', 'Delhi Test Area Team', 'area', 'Delhi', 'New Delhi', 'Connaught Place');
...
ROLLBACK;
"""
sftp.putfo(io.BytesIO(sql.encode()), "/tmp/verify_routing.sql")
_, stdout, stderr = c.exec_command("docker exec -i supabase-db psql -U supabase_admin -d postgres -t -c \"$(cat /tmp/verify_routing.sql)\"")
