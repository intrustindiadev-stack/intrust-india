...
"""
sftp.putfo(io.BytesIO(sql.encode()), "/tmp/desc_crm_leads.sql")
_, stdout, stderr = c.exec_command("docker exec -i supabase-db psql -U supabase_admin -d postgres < /tmp/desc_crm_leads.sql")
