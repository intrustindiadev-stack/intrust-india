...
export default function ServiceLeadsPage() {
    ...
    const fetchLeads = useCallback(async (isBackground = false) => {
        ...
        try {
            const searchObj = new URLSearchParams(searchParams.toString());
            searchObj.set('service', service);
            const res = await fetch(`/api/crm/leads?${searchObj.toString()}`, {
            ...
            <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div className="flex flex-col gap-2 flex-1">
                        ...
                        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight flex items-center gap-3 capitalize">
                            {service.replace('-', ' ')} Leads
