...
import { Search, ChevronRight, Store, MapPin } from 'lucide-react';
        ...
        <div className="relative z-10">
            ...
            <div className="flex items-end justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm font-medium text-slate-500 dark:text-white/30 mt-1">Shop directly from trusted local merchants</p>
                </div>
            ...
            <motion.div 
                ...
                initial="hidden"
                animate="show"
                className="grid grid-cols-2 block sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4 lg:gap-5"
            >
                {filtered.length === 0 ? (
                    <div className="col-span-full py-12 text-center">
                        <p className="text-slate-500 dark:text-white/40 font-bold mb-2">No merchants found matching "{searchQuery}"</p>
                    </div>
                ) : (
