...
// PATCH /api/employee/notifications — mark notifications as read
export async function GET(request) {
    try {
        ...
        console.error('[API] Employee Notifications GET Error:', error);
...
export async function PATCH(request) {
    try {
        ...
        console.error('[API] Employee Notifications PATCH Error:', error);
        return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
    }
}
