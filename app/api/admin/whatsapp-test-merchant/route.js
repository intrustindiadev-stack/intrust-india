...
const TEMPLATE_MAP = {
  ...
  intrust_merchant_procurement_sale: MERCHANT_PROCUREMENT_SALE_TEMPLATE,
  intrust_order_status_v1: ORDER_STATUS_TEMPLATE,
  intrust_wallet_low_balance_v1: WALLET_LOW_BALANCE_TEMPLATE,
  intrust_kyc_reminder_v1: KYC_REMINDER_TEMPLATE,
  intrust_udhari_due_reminder_v1: UDHARI_DUE_REMINDER_TEMPLATE,
  intrust_merchant_subscription_expiring_v1: MERCHANT_SUBSCRIPTION_EXPIRING_TEMPLATE,
  intrust_merchant_payout_failed_v1: MERCHANT_PAYOUT_FAILED_TEMPLATE,
  intrust_investment_maturity_v1: INVESTMENT_MATURITY_TEMPLATE,
  intrust_merchant_transaction_alert_v1: MERCHANT_TRANSACTION_ALERT_TEMPLATE,
  intrust_gm_greet_v1: GM_GREET_TEMPLATE,
  intrust_gm_tip_v1: GM_TIP_TEMPLATE,
  intrust_ge_greet_v1: GE_GREET_TEMPLATE,
  intrust_reward_milestone_v1: REWARD_MILESTONE_TEMPLATE,
  intrust_referral_invite_v1: REFERRAL_INVITE_TEMPLATE,
  intrust_giftcard_promo_v1: GIFTCARD_PROMO_TEMPLATE,
  intrust_winback_v1: WINBACK_TEMPLATE,
  intrust_feature_announce_v1: FEATURE_ANNOUNCE_TEMPLATE,
  intrust_festival_greeting_v1: FESTIVAL_GREETING_TEMPLATE,
};
