...
/**
 * GET /api/merchant/chat/sessions
 *
 * Returns the authenticated merchant user's past merchant conversations,
 * ordered by last_active_at desc. Only includes sessions with ≥1 message.
 * Enforces role gate: merchant / admin / super_admin.
 *
 * Query params:
...
export async function GET(req) {
  try {
    ...
    // Step 1: Fetch recent merchant sessions for this user
    ...
    console.error('[merchant/chat/sessions] Unhandled error:', err);
