...
import { Store, LayoutDashboard, ShoppingBag, ArrowLeft, Headphones } from 'lucide-react';
    ...
    return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 sm:p-6 text-center animate-in fade-in duration-300">
            <div className="max-w-md w-full bg-white dark:bg-[#11131a] rounded-[2.5rem] border border-slate-100 dark:border-white/10 p-8 sm:p-10 shadow-2xl shadow-slate-200/50 dark:shadow-none relative overflow-hidden">
                ...
                {/* 404 Badge */}
                <div className="w-16 h-16 rounded-2xl bg-amber-500/10 dark:bg-[#D4AF37]/10 text-amber-600 dark:text-[#D4AF37] flex items-center justify-center mx-auto mb-6 border border-amber-500/20 shadow-inner">
                    <Store size={32} />
                </div>

                <div className="inline-block px-3 py-1 rounded-full bg-slate-100 dark:bg-white/5 text-[11px] font-black uppercase tracking-[0.25em] text-slate-500 dark:text-slate-400 mb-3">
                    404 · Page Not Found
                </div>

                <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight mb-3">
                    Merchant Section Not Found
                </h1>

                <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed mb-8">
                    The page or resource you are looking for does not exist, has been moved, or requires different account permissions.
                </p>
