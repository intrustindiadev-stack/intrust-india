    ...
    return (
        <div className="max-w-2xl mx-auto px-4 sm:px-6 pb-24">
            ...
            <div className="mt-10 py-12 text-center space-y-4 border-t border-slate-100 dark:border-slate-800/50 pt-10">
                ...
                <div className="max-w-md mx-auto bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                    <p className="text-[9px] font-medium text-slate-500 dark:text-slate-400 leading-relaxed text-left">
                        <strong className="text-slate-700 dark:text-slate-300">Service Disclaimer:</strong> INTRUST India acts solely as a technology platform and service provider facilitating E-commerce, Digital Gift Cards, and Premium NFC Services. We provide the infrastructure to process your customer orders and payouts. Our role is strictly to assist you with technology services.
                    </p>
                </div>
            </div>
