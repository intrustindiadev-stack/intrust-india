...
export default function MerchantOrderDetailClient({ order, merchantInfo }) {
    ...
    return (
        <div className="space-y-6 pb-28">
            ...
            {/* ── Transaction Ledger ── */}
            <div className="bg-white dark:bg-white/[0.03] border border-slate-100 dark:border-white/10 rounded-3xl overflow-hidden shadow-sm">
                ...
                <div className="p-5 space-y-3">
                    <div className="flex justify-between items-center text-xs">
                        <span className="text-slate-500 dark:text-gray-400 font-medium">Gross Transaction Value</span>
                        <span className="font-bold text-slate-900 dark:text-white">₹{((order.total_amount_paise || 0) / 100).toLocaleString("en-IN")}</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                        <span className="text-slate-500 dark:text-gray-400 font-medium">Total Sales Profit</span>
