...
export default function ManualInvoiceGeneratorPage() {
    ...
    const handleShareWhatsApp = () => {
        ...
        const text = `Dear ${customer.name || 'Customer'},\n\nPlease find your Intrust India Invoice #${generatedInvoiceData.invoice_number} for ₹${formatCurrency(payableAmt)}.\n\nView and pay online here:\n${generatedInvoiceData.payment_url}\n\nThank you,\nIntrust India`;
        ...
        <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-10">
            <div className="max-w-5xl mx-auto space-y-6 pb-24">
                ...
                {generatedInvoiceData ? (
                    <div className="bg-white rounded-[1.5rem] shadow-sm border border-emerald-100 p-8 max-w-2xl mx-auto text-center space-y-6">
                        ...
                        <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 text-left space-y-3">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-bold text-slate-900">₹{formatCurrency(generatedInvoiceData.grand_total_paise / 100)}</span>
                            </div>
                            <div className="flex justify-between border-t border-slate-200 pt-3">
                                <span className="text-slate-500 font-medium">Payment Status</span>
                                <span className="font-black text-amber-600 uppercase">UNPAID (ISSUED)</span>
                            </div>
                        </div>
                        ...
                        <div className="text-left space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={handleCopyLink} className="px-4 py-3 bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white rounded-xl font-bold transition-all text-sm">
                                    Copy Link
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                            <a href={generatedInvoiceData.payment_url} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 px-4 py-3 bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white rounded-xl font-bold transition-all text-sm">
                                Open Payment Page
                            </a>
                            <button onClick={handleDownloadAgain} className="flex items-center justify-center gap-2 px-4 py-3 bg-slate-900 text-white rounded-xl font-bold hover:bg-slate-800 transition-all text-sm">
                                <Download size={16} /> Download Invoice
                            </button>
                        </div>

                        <div>
                            <button onClick={handleShareWhatsApp} className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-600 hover:text-white rounded-xl font-bold transition-all text-sm">
                                <Send size={15} /> Share via WhatsApp
                            </button>
                        </div>
                        
                        <button onClick={() => { setGeneratedInvoiceData(null); setInvoiceMeta({...invoiceMeta, invoice_number: `INV-${Date.now().toString(36).toUpperCase()}`}); }} className="mt-4 text-sm font-bold text-slate-400 hover:text-slate-600 underline">
