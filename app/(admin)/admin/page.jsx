            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
                ...
                <div className="flex overflow-x-auto pb-6 -mx-4 px-4 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 hide-scrollbar snap-x snap-mandatory">
                    ...
                    <div className="snap-center shrink-0 w-[85vw] sm:w-auto relative group overflow-hidden bg-white backdrop-blur-xl rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 className="text-2xl sm:text-3xl font-bold text-gray-900">{formatPrice(revenueData)}</h3>
                    </div>
                    ...
                    <div className="snap-center shrink-0 w-[85vw] sm:w-auto relative group overflow-hidden bg-white backdrop-blur-xl rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
                        ...
                        <p className="text-sm font-medium text-gray-500 mb-1">Active Merchants</p>
                        <h3 className="text-2xl sm:text-3xl font-bold text-gray-900">{activeMerchantsCount}</h3>
                    </div>
                    ...
                    <div className="snap-center shrink-0 w-[85vw] sm:w-auto relative group overflow-hidden bg-white backdrop-blur-xl rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
                        ...
                        <p className="text-sm font-medium text-gray-500 mb-1">Total Coupons Listed</p>
                        <h3 className="text-2xl sm:text-3xl font-bold text-gray-900">{totalCouponsCount}</h3>
                    </div>
