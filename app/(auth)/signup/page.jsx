...
import { Phone, ArrowRight, Loader2, ShieldCheck, User } from 'lucide-react';
...
<<<<<<< HEAD
            ...
            // Let's rely on router, but if it hangs, at least log it.
            // Actually, best practice:
            // 1. Session is set.
            // 2. Redirect.

            // Should we set loading false?
            // User says "Never Completes". If we set loading false here, they can click again.
            // But if we don't, and redirect fails, they are stuck.
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
                    {step === 'details' ? (
                        <>
                            ...
                            <div className="relative mb-6">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-4 bg-white text-gray-500">Or sign up with phone</span>
                                </div>
                            </div>
                        ...
                        <>
                            <div className="mb-6">
                                ...
                                <div className="p-4 bg-[#92BCEA]/10 rounded-xl">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <Link href="/login" className="text-[#92BCEA] font-semibold hover:underline">
                                Login
                            </Link>
                        </p>
                    </div>
