              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center overflow-hidden shrink-0 ${
                    isDark ? 'bg-slate-700' : 'bg-white border border-slate-100'
                  }`}>
                    {itemImage ? (
                  ...
                  <div>
                    <h4 className={`font-bold text-sm sm:text-base line-clamp-1 group-hover:text-emerald-500 transition-colors ${
                    ...
                    <p className={`text-xs mt-1 font-medium flex items-center gap-1 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                      <Clock className="w-3 h-3" />
                      {format(new Date(order.created_at), "MMM d, yyyy")}
                    </p>
                    <div className={`mt-1 flex items-center gap-1.5 text-[10px] font-bold ${isDark ? 'text-white/30' : 'text-slate-400'}`}>
                      <Store size={10} />
                ...
                <div className="text-right">
                  ...
                  <p className={`text-[10px] uppercase font-black px-2 py-0.5 rounded mt-1 inline-block ${
