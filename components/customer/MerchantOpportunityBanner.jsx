            ...
            <div className="relative bg-gradient-to-br from-green-600 to-emerald-600 rounded-xl p-6 sm:p-8">
                <div className="flex flex-col lg:flex-row items-center gap-6">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <p className="text-green-100 text-sm sm:text-base max-w-2xl mx-auto lg:mx-0">
                    ...
                    <div className="flex-shrink-0 mt-6 lg:mt-0 w-full lg:w-auto flex justify-center lg:justify-end">
                        <Link
                            href="/merchant-apply"
                            className="group inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-white hover:bg-gray-100 text-green-600 font-bold rounded-xl transition-all shadow-lg hover:shadow-2xl hover:scale-105 w-full sm:w-auto"
                        >
                            Apply Now
