        ...
        <div className={`w-full rounded-2xl border transition-all duration-500 p-6 sm:p-10 relative overflow-visible ${isDark
            ...
            {hasExistingOrder ? (
                <div className="flex flex-col items-center justify-center py-10 text-center">
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${isDark ? 'bg-blue-500/10 text-blue-400' : 'bg-blue-50 text-blue-600'}`}>
                        <Check size={32} strokeWidth={3} />
                    </div>
                    <h3 className={`text-xl font-black uppercase tracking-tight italic mb-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>Card Already Ordered</h3>
                    <p className={`text-sm font-medium tracking-tight mb-6 max-w-md ${isDark ? 'text-white/50' : 'text-slate-500'}`}>
                        ...
                        {stepLabels.map((label, i) => {
                            ...
                            return (
                                <div key={s} className="flex items-center flex-1 last:flex-none">
                                    ...
                                    {s < 3 && (
                                        <div className={`flex-1 h-[1.5px] mx-3 rounded-full transition-colors duration-300 ${step > s ? "bg-blue-600" : isDark ? "bg-white/[0.05]" : "bg-slate-200"
                                            }`} />
                                    )}
                                </div>
                            );
