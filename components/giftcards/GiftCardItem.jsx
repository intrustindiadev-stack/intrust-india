    ...
    return (
        ...
        >
            <div className="group relative bg-white rounded-3xl overflow-hidden border border-gray-100 hover:border-[#92BCEA]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#92BCEA]/20 hover:-translate-y-2 h-full flex flex-col">
                ...
                <div className={`relative h-36 sm:h-48 bg-gradient-to-br ${coupon.gradient} overflow-hidden`}>
                ...
                <div className="p-3 sm:p-5 flex-1 flex flex-col bg-gradient-to-b from-white to-gray-50/50">
                    ...
                    <Link
                        ...
                        className="w-full py-2 sm:py-3.5 bg-gradient-to-r from-gray-900 to-gray-800 hover:from-[#92BCEA] hover:to-[#AFB3F7] text-white font-bold text-sm rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-[#92BCEA]/30 flex items-center justify-center gap-2 group/btn mt-auto"
                    >
                        <span>Buy Now</span>
