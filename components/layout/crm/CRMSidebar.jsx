            ...
            `}>
                <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                    <Link href="/crm" className="flex items-center gap-3 group">
                        ...
                        <div>
                            <div className="font-extrabold text-lg bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-indigo-600 to-indigo-500 tracking-tight">INTRUST</div>
                            <div className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest">CRM Sales Suite</div>
                        </div>
                    </Link>
