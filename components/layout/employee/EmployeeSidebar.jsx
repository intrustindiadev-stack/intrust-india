            ...
            `}>
                <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                    <Link href="/employee" className="flex items-center gap-3 group">
                        ...
                        <div>
                            <div className="font-extrabold text-lg bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-amber-600 to-amber-500 tracking-tight">INTRUST</div>
                            <div className="text-[10px] font-bold text-amber-600 uppercase tracking-widest">Employee Portal</div>
                        </div>
                    </Link>
