...
### Verified Live Rate Card Breakdown (Wallet User Pricing)
| Delivery Zone | Applicable Route | Verified Flat Rate | Typical SLA | Intrust Product Fit |
| :--- | :--- | :--- | :--- | :--- |
| **Zone A (Intracity)** | Within Bhopal City Limits | **₹39 Flat** | 2 – 4 Hours / Same-Day | Fresh Groceries, Dairy, Vegetables, Urgent Essentials |
| **Zone B (Within Zone)** | Central India / Madhya Pradesh (Indore, Jabalpur) | **₹49 Flat** | 24 – 48 Hours | Regional Merchant Goods, Packaged FMCG, Apparel |
| **Zone C/D (Metro & ROI)** | Major Metros & Rest of India (Pan-India) | **₹59 Flat** | 2 – 4 Days | Standard E-Commerce Apparel, Electronics, Accessories |
| **Zone E (Special Zone)** | Northeast, Jammu & Kashmir, Islands | **₹69 Flat** | 5 – 7 Days | Extended Remote National Deliveries |

> **Verified Portal Terms:**
> - **No Extra RTO Charges:** Failed deliveries returning to merchant do not incur punitive fees.
> - **No COD Handling Charges:** ₹0 fee on Cash on Delivery orders (saving ₹40–50/order).
> - **COD Remittance in 2 Days:** Payout into Intrust's bank account within 48 hours at 0 extra cost.
