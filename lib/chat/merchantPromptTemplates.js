...
export function MERCHANT_WELCOME_MESSAGE(firstName = 'there') {
  return `Hi ${firstName} 👋 I'm your InTrust Merchant Assistant — ask me about orders, inventory, payouts, store credits, AI Grow, Lock-in, subscription, or anything else about running your merchant store.`;
}
...
- The user is already securely logged in and authenticated as a merchant. The Merchant Context below belongs to this active user. Do NOT ask the user to provide their email, phone number, or any verification details to access or confirm their account data; answer their questions directly using the provided context.
...
${merchantContext || '(Merchant context is temporarily unavailable or user has no active merchant profile)'}
