...
export const PAGE_GUIDES = {
  ...
  '/admin/investments': { // Changed from /admin/ai-grow since it uses investments path
    title: 'AI Grow',
    icon: Sprout,
    overview: 'Overview of the AI Grow growth program: participating merchants, pooled balances, and trade distribution health.',
    keyActions: [
      { label: 'Monitor the pool', description: 'Headline cards show total deployed capital balance across all merchants.' },
      { label: 'Open a wallet', description: 'Jump to the Wallets page to adjust an individual merchant balance.' },
    ],
    glossary: [
      { term: 'Trade profit payout', meaning: 'Automated trade profit distribution credited to merchant wallets on schedule.' },
    ],
  ...
  '/admin/ai-grow/wallets': {
    ...
    icon: Wallet,
    overview: 'View every AI Grow merchant trade wallet and make manual balance adjustments with a full audit trail.',
    keyActions: [
