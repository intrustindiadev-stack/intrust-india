...
export function salaryProcessedTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #eff6ff; border: 1px solid #bfdbfe; border-left: 4px solid #2563eb; padding: 16px 20px; margin: 20px 0; border-radius: 8px;">
            <p style="margin: 0 0 8px 0; font-size: 14px; color: #1e40af;">Period: <strong style="color: #1e3a8a;">${escapeHtml(monthName)} ${escapeHtml(year)}</strong></p>
            <p style="margin: 0; font-size: 18px; color: #1e40af;">Net Salary Disbursed: <strong style="color: #2563eb; font-size: 22px;">${formatRs(netSalaryRs)}</strong></p>
        </div>
