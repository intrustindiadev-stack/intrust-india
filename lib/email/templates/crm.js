...
export function leadConvertedTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #eff6ff; border: 1px solid #bfdbfe; border-left: 4px solid #2563eb; padding: 16px 20px; margin: 20px 0; border-radius: 8px;">
            <p style="margin: 0 0 4px 0; font-size: 14px; color: #1e40af;">Converted Lead: <strong style="color: #1e3a8a;">${escapeHtml(leadName)}</strong></p>
            <p style="margin: 0; font-size: 14px; color: #1e40af;">Target: <strong style="color: #1e3a8a;">${escapeHtml(type.toUpperCase())}</strong></p>
        </div>
