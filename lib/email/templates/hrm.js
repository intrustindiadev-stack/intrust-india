...
export function candidateHiredWelcomeTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #f0fdf4; border-left: 4px solid #059669; padding: 14px 18px; margin: 20px 0; border-radius: 4px;">
            <p style="margin: 0 0 6px 0; font-size: 14px; color: #166534;">Role: <strong>${escapeHtml(jobTitle)}</strong></p>
            <p style="margin: 0 0 6px 0; font-size: 14px; color: #166534;">Department: <strong>${escapeHtml(department)}</strong></p>
            <p style="margin: 0; font-size: 14px; color: #166534;">Joining Date: <strong>${escapeHtml(joiningDate)}</strong></p>
        </div>
        ...
        ${tempPassword ? `
            <div style="background-color: #f8fafc; border: 1px dashed #94a3b8; padding: 14px 18px; margin: 20px 0; border-radius: 4px;">
                ...
                <p style="margin: 0 0 4px 0; font-size: 14px; color: #0f172a;">Portal URL: <a href="${actionUrl}" style="color: #059669;">${actionUrl}</a></p>
