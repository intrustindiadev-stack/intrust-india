...
export function applicationReceivedTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #f8fafc; border-left: 4px solid #059669; padding: 14px 18px; margin: 20px 0; border-radius: 4px;">
            <p style="margin: 0 0 6px 0; font-size: 14px; color: #475569;">Registered Business: <strong style="color: #0f172a;">${safeBusiness}</strong></p>
            <p style="margin: 0; font-size: 14px; color: #475569;">Application Status: <strong style="color: #059669;">Under Review (Manual Verification)</strong></p>
        </div>
...
export function applicationApprovedTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #f0fdf4; border-left: 4px solid #059669; padding: 16px 20px; margin: 20px 0; border-radius: 4px;">
            <p style="margin: 0 0 8px 0; font-size: 15px; font-weight: 600; color: #166534;">Next Step: Activate Merchant Panel</p>
