...
<body>
  <div class="wrapper">
    <div class="card">
      <div style="background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 100%); background-color: #1e3a8a; padding: 32px 40px; border-bottom: 3px solid #1d4ed8;">
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="vertical-align: middle; padding-right: 14px;">
                    <img src="https://intrustindia.com/email-templates/icons/logo-badge.png" alt="InTrust India" width="44" height="44" style="display: block; width: 44px; height: 44px; border: 0; outline: none; text-decoration: none;" />
                  </td>
                  <td style="vertical-align: middle;">
                    <div style="font-size: 22px; font-weight: 800; letter-spacing: -0.3px; margin: 0; line-height: 1.2; color: #ffffff;">
                      Intrust India
                    </div>
                  </td>
                </tr>
            ...
            <td align="right" style="vertical-align: middle;">
              <span style="color: #bfdbfe; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 1.2px;">Inquiry Alert</span>
            </td>
          </tr>
        </table>
      </div>
      <div style="background: linear-gradient(135deg, #1e40af 0%, #2563eb 100%); padding: 20px 28px; color: #ffffff;">
        <h1 style="margin: 0; font-size: 20px; font-weight: 700; color: #ffffff;">New Contact Form Inquiry</h1>
        <p style="margin: 4px 0 0 0; font-size: 13px; color: #bfdbfe;">A visitor has submitted a message via intrustindia.com/contact</p>
      </div>
      <div class="content">
