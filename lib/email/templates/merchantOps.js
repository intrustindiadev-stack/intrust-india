...
export function payoutStatusUpdateTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #f8fafc; border-left: 4px solid ${current.badge}; padding: 14px 18px; margin: 20px 0; border-radius: 4px;">
            ...
            ${utrReference ? `<p style="margin: 0; font-size: 14px; color: #0f172a;">Bank UTR / Ref: <strong style="color: #059669;">${escapeHtml(utrReference)}</strong></p>` : ''}
        </div>
...
export function storeCreditRequestTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #f8fafc; border-left: 4px solid #059669; padding: 14px 18px; margin: 20px 0; border-radius: 4px;">
            <p style="margin: 0 0 6px 0; font-size: 14px; color: #475569;">Item: <strong style="color: #0f172a;">${escapeHtml(itemTitle)}</strong></p>
            <p style="margin: 0 0 6px 0; font-size: 14px; color: #475569;">Customer: <strong style="color: #0f172a;">${escapeHtml(customerName)}</strong></p>
            <p style="margin: 0; font-size: 16px; color: #0f172a;">Credit Amount: <strong style="color: #059669;">${formatRs(amountRs)}</strong></p>
        </div>
