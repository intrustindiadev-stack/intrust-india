...
export function orderConfirmedTemplate({
    ...
    const bodyHtml = `
        ...
        <div style="background-color: #f8fafc; border-left: 4px solid #059669; padding: 14px 18px; margin: 20px 0; border-radius: 4px;">
            ...
            <p style="margin: 0; font-size: 16px; color: #0f172a;">Total Paid: <strong style="color: #059669;">${formatRs(orderTotalRs)}</strong></p>
        </div>
...
export function udhariDecisionTemplate({
    ...
    const bodyHtml = isApproved ? `
        ...
        <div style="background-color: #f0fdf4; border-left: 4px solid #059669; padding: 14px 18px; margin: 20px 0; border-radius: 4px;">
            <p style="margin: 0 0 6px 0; font-size: 14px; color: #166534;">Amount Deferred: <strong>${formatRs(amountRs)}</strong></p>
            <p style="margin: 0; font-size: 14px; color: #166534;">Repayment Window: <strong>${escapeHtml(days)} Days</strong></p>
        </div>
