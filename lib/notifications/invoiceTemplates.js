              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="vertical-align: middle; padding-right: 10px;">
                    <img src="https://intrustindia.com/email-templates/icons/logo-badge.png" alt="InTrust Logo" width="36" height="36" style="display: block; width: 36px; height: 36px; border: 0; outline: none;" />
                  </td>
                  <td style="vertical-align: middle; font-weight: 800; font-size: 22px; color: #0f172a; letter-spacing: -0.3px;">
                    Intrust <span style="color: #2563eb;">India</span>
                  </td>
                </tr>
                <tr>
                  <td colspan="2" align="center" style="font-size: 11px; color: #64748b; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 700; padding-top: 4px;">
