 ...
 * Sent when a merchant onboarding is approved.
 *
 * ─── OMNIFLOW TEMPLATE SPEC ─────────────────────────────────────────────────
 *   Template Name : intrust_merchant_approved
 *   Category      : Utility
 *   Language      : English
 *   Header        : (none)
 *   Body          :
 ...
 *   Buttons       : [Quick Reply] Start Selling, [Quick Reply] Tutorial Guide
 *   Variables     : 
 *     {{1}} = Business Name
 *     {{2}} = Next Step
 * ────────────────────────────────────────────────────────────────────────────
...
export const MERCHANT_APPROVED_TEMPLATE = {
  name: 'intrust_merchant_approved_v2',
  language: 'en_US',
 ...
 * Sent when a merchant's subscription plan status is updated.
 *
 * ─── OMNIFLOW TEMPLATE SPEC ─────────────────────────────────────────────────
 *   Template Name : intrust_merchant_subscription_status
 *   Category      : Utility
 *   Language      : English
 *   Header        : (none)
 *   Body          :
 ...
 *   Buttons       : [Quick Reply] Renew Now, [Quick Reply] Compare Plans
 *   Variables     : 
 *     {{1}} = Status
 *     {{2}} = Renewal/Expiry
 * ────────────────────────────────────────────────────────────────────────────
 *
 * @param {string} status - Status
 * @param {string} expiry - Renewal/Expiry
 * @returns {Array} Omniflow components array
 */
export const MERCHANT_SUBSCRIPTION_STATUS_TEMPLATE = {
  name: 'intrust_merchant_subscription_status_v2',
  language: 'en_US',
