...
export const sabpaisaConfig = {
    clientCode: (process.env.SABPAISA_CLIENT_CODE || process.env.NEXT_PUBLIC_SABPAISA_CLIENT_CODE || '').trim(),
    username: (process.env.SABPAISA_USERNAME || process.env.NEXT_PUBLIC_SABPAISA_USERNAME || '').trim(),
    password: (process.env.SABPAISA_PASSWORD || process.env.NEXT_PUBLIC_SABPAISA_PASSWORD || '').trim(),
    authKey: (process.env.SABPAISA_AUTH_KEY || process.env.NEXT_PUBLIC_SABPAISA_AUTH_KEY || '').trim(),
    authIV: (process.env.SABPAISA_AUTH_IV || process.env.NEXT_PUBLIC_SABPAISA_AUTH_IV || '').trim(),
