-- ============================================================================
-- FIX: Waive KYC for Level 0 Daily Login and Signup Rewards
-- Date: 2026-05-08
-- Description:
--   Update calculate_and_distribute_rewards to allow direct rewards (Level 0)
--   for 'daily_login' and 'signup' events to be distributed even if the user
--   has not completed KYC. Referral rewards (Level 1+) still require KYC.
-- ============================================================================
