-- Replace submit_leave_request to remove the v_available < v_chargeable check
-- This ensures employees can request leave regardless of balance, allowing HR to make the final decision.
