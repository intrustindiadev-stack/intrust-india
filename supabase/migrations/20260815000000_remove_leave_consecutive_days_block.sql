-- Replace submit_leave_request to remove min_notice_days and max_consecutive_days blocks
-- This ensures employees can request any duration of leave, allowing HR to review.
