-- 20260828000002_fix_fashion_checkout_atomicity.sql

BEGIN;

-- 1. Add atomic constraint to guarantee no negative inventory
ALTER TABLE public.fashion_variants
DROP CONSTRAINT IF EXISTS fashion_variants_inventory_quantity_check;

ALTER TABLE public.fashion_variants
ADD CONSTRAINT fashion_variants_inventory_quantity_check CHECK (inventory_quantity >= 0);

-- 2. Update checkout to use atomic update and handle failure gracefully
