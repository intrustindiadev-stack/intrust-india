-- Migration: 20260912000001_add_packed_at_to_merchant_get_my_orders.sql
-- Description: Add packed_at to merchant_get_my_orders RPC output so orders page has fulfillment timestamp.
